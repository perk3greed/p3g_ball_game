...
func _ready():
	...
	Events.connect("assign_the_biggest_deviation_left", change_cube_deviation)
...
#	print("left cube pos" , current_cube_position_spawn)


func change_cube_deviation(change_cube_deviation_left):
	current_cube_elevation = change_cube_deviation_left
